...
This rust program constructs the Algebraic EHP sequence, both constructing every $H^*(\Lambda_n)$ and all differentials in the AEHP sequence. This generates the file algebraic_data.ts which is automatically placed inside /site/src. This python program is nothing special, it is mostly a formatting problem. 
