use std::{collections::HashMap, fs::File, io::{BufRead, BufReader}, sync::LazyLock};
...
fn read_csv(bot_trunc: i32, top_trunc: i32, file_name: &str, add_one_af: bool, include_zero: bool) ->  HashMap<(i32, i32), Vec<Torsion>> {
    let mut m = HashMap::new();
...
pub fn read_rp_csv(bot_trunc: i32, top_trunc: i32, include_zero: bool) -> HashMap<(i32, i32), Vec<Torsion>> {
